export default function PrivacyPolicy() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">Last Updated: July 15, 2026</p>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>AI Providers:</strong> AI inference is performed via Google&apos;s Gemini API, OpenAI&apos;s GPT-4o-mini API, or Anthropic&apos;s Claude API, selected automatically by our routing layer based on availability. Certain features, such as Eat Now, exclusively use Google Gemini because they require real-time search capabilities only available through this provider. All providers process data for inference only, under their respective API terms of service. We do not share personally identifiable information with any provider.</li>
            <li><strong>No Persistence:</strong> Our routing layer processes data in memory and does not log, store, or retain your data after the request is complete. AI providers process your data under their own API terms. For reference: <a href="https://ai.google.dev/gemini-api/terms" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">Google Gemini</a>,{' '}<a href="https://openai.com/policies/terms-of-use" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">OpenAI GPT-4o-mini</a>,{' '}<a href="https://www.anthropic.com/legal/commercial-terms" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">Anthropic Claude</a>.</li>
        ...
        <section>
          ...
          <p className="mb-2">Your coordinates are sent directly from your device to these providers to resolve the environmental reading. No health data is included in these requests. Your coordinates are not stored by Flair or linked to any identity. You can disable environment data in Settings.</p>

export default function PrivacyPolicy() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <p className="mb-8">Flair Health is a local-first wellness app. This policy explains what data leaves your device, when, and why — and what we cannot do with it even if we wanted to.</p>
      <div className="space-y-8">
        <section>
          ...
          <p className="mt-3">The only exception is when you explicitly invoke an AI feature (Level Up, Magic Lens). See Section 4.</p>
          <p className="mt-2">A randomly-generated, non-identifiable session token is included with AI requests solely for rate-limiting. It is not linked to you, your device, or your health data.</p>
        </section>
        <section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li><strong>In-Transit Processing:</strong> When you trigger Level Up, a structured summary of your day&apos;s journal entries, anonymous health profile buckets (age range, sex, BMI category), your stated health objective, and your active Blueprint targets are sent to our serverless routing layer over HTTPS. For Magic Lens, a compressed copy of your meal photo is sent. No names, exact biometrics, or account identifiers are transmitted.</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Workout route data (GPS), if synced, is stored only on your device and is never transmitted.</li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <p>To maintain stability, Flair may collect anonymized crash logs (stack traces only). These contain no health data, no journal content, and no personally identifiable information. If specific crash reporting tools are used, they will be named here.</p>
        </section>
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Note: Data that originates from Apple Health or Google Health Connect is not deleted when you uninstall Flair. That data is managed through those platforms directly.</li>
          </ul>
        </section>
        <section>

export default function PrivacyPolicy() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">Last Updated: May 6, 2026</p>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Bio Age</strong> sends your anonymised health profile, activity patterns, and health vault biomarkers to estimate your biological age and generate a confidence score. No names, exact biometrics, or account identifiers are transmitted.</li>
            <li><strong>AI Providers:</strong> AI inference is performed via Google&apos;s Gemini API, xAI&apos;s Grok API, or OpenAI&apos;s GPT-4o-mini API. The provider may be selected automatically by our routing layer or chosen by you (premium feature). All providers process data under their respective API terms of service, which prohibit use of API inputs for model training. We do not share personally identifiable information with any provider.</li>
            ...
            <li><strong>Anonymous Telemetry:</strong> Each AI request logs an anonymous, randomly-generated identifier (rotated weekly), the feature used, the AI model that served the request, token counts, and response latency. This data is used solely for aggregate cost analysis and service reliability monitoring. It contains no health data, no journal content, and cannot be linked to your identity.</li>

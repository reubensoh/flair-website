      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Anonymous Telemetry:</strong> Flair&apos;s routing layer generates a daily-rotating anonymous identifier (a hash that changes each day), used internally for rate-limiting and abuse prevention. This identifier is not included in requests to AI providers. It is not a persistent identifier and cannot be used to track you across time. Any persistent per-install identifier the App generates is stored locally on your device only and is never transmitted.</li>

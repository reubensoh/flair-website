      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Before any AI feature you initiate sends data, Flair displays a consent form showing every specific data field that will be shared, rendered from the same code that builds the real request. This field-level transparency lets you see exactly what is being transmitted and why. Standing context you&apos;ve enabled, such as weather and environmental data (see Section 9), runs on a simpler permission toggle rather than this per-send preview.</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Mistral AI (France):</strong> Mistral is an available AI provider for most Flair features: Do Now, Blueprint, Weekly Report, Body Age, Inspire Me, journal analysis, Document Scanner, and Magic Lens. When you select Mistral as your AI provider for any of these features, it receives the data required for that feature, formatted according to the consent form you approved: your health context, journal entries, medical conditions, vital signs, and biomarker data (if available from scanned documents), or for Magic Lens, a compressed copy of your photo.</li>
            ...
            <li><strong>Anonymous Telemetry:</strong> Requests to our AI providers include a weekly-rotating anonymous identifier (a hash that changes each week), used for rate-limiting and abuse prevention. It is not a persistent identifier and cannot be used to track you across time. Any persistent per-install identifier the App generates is stored locally on your device only and is never transmitted.</li>

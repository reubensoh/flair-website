export default function PrivacyPolicy() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">Last Updated: May 26, 2026</p>
      ...
      <div className="space-y-8">
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>The only exception is when you explicitly invoke an AI feature (Level Up, Magic Lens, Eat Now, Document Scanner, Bio Age, Blueprint Protocol, or Inspire Me). Each feature requires your explicit approval via an in-app consent prompt before any data is transmitted. See Section 4. Flair makes no network request on app launch — the first server contact only occurs when you actively use an AI feature and have provided explicit consent.</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>Flair requests read-only access to steps, workouts, sleep, heart rate, resting heart rate, heart rate variability (HRV), blood oxygen, respiratory rate, and GPS routes.</li>
          ...
          <p className="mt-3">With your permission, Flair imports the following data from Apple Health: workouts, sleep sessions, resting heart rate, heart rate variability (HRV), blood oxygen saturation (SpO2), and respiratory rate. This data is stored locally on your device and is never transmitted to any server unless you explicitly invoke an AI feature that includes it (such as Bio Age). Flair also reads which apps or wearable devices have written data to Apple Health (for example, Garmin Connect or Oura) to detect your connected devices. This information is stored locally and only the brand category (e.g. &quot;Garmin&quot;, &quot;Oura&quot;) — not the device model or firmware version — is included in Level Up requests with your explicit consent.</p>
        </section>
        <section>

    ...
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mb-2">By using features like &quot;Level Up,&quot; &quot;Magic Lens,&quot; &quot;Eat Now,&quot; &quot;Document Scanner,&quot; &quot;Bio Age,&quot; &quot;Inspire Me,&quot; and the Blueprint Protocol, you acknowledge that:</p>
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>The Blueprint Protocol may temporarily pause or deprioritize tasks based on your own journal entries (e.g., a logged injury or illness). This reflects your recorded context and is not a medical recommendation to avoid any activity. Always consult a healthcare provider for injury- or illness-related decisions.</li>
            ...
            <li>Bio Age estimates are generated by AI based on self-reported and device-imported data. They are not a medical diagnosis. Actual biological age cannot be determined without clinical laboratory testing. Flair Health is not liable for health decisions based on Bio Age estimates.</li>
            <li>Inspire Me generates creative, personalised activity suggestions based on your blueprint task and health context. Suggestions are for lifestyle inspiration only — they are not prescriptions, exercise programs, or dietary plans. You are responsible for assessing whether any suggestion is appropriate for your individual circumstances.</li>

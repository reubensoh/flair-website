export default function TermsOfService() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">Version 37. Last Updated: August 25, 2026.</p>
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Health Wallet</strong> projections are population-level estimates derived from epidemiological data. They are not personalized medical or financial predictions.</li>
        ...
        <section>
          ...
          <p className="mb-2">By using features like &quot;Refresh Insights,&quot; &quot;Magic Lens,&quot; &quot;Eat Now,&quot; &quot;Document Scanner,&quot; &quot;Body Age,&quot; &quot;Inspire Me,&quot; &quot;Weekly Wrapped,&quot; &quot;Do Now,&quot; and Daily Quests, you acknowledge that:</p>
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Inspire Me generates creative, personalized activity suggestions based on your Daily Quests task and health context. Suggestions are for lifestyle inspiration only: they are not prescriptions, exercise programs, or dietary plans. You are responsible for assessing whether any suggestion is appropriate for your individual circumstances.</li>
            <li>Weekly Wrapped generates an AI-powered summary of your past 7 days of wellness activity. It is an automated lifestyle review, not a medical assessment or clinical report. You are responsible for reviewing the content and consulting a healthcare provider for any medical concerns.</li>
            <li>AI inference may be performed by multiple third-party providers (currently Google Cloud Vertex AI, OpenAI GPT-4.1-mini and GPT-4.1, and Anthropic Claude). Provider selection is generally automatic and based on service availability. Certain features, such as Eat Now, exclusively use Google Cloud Vertex AI because they require real-time location search, a capability only available through this provider.</li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            ...
            <li>Projections are derived from <strong>population-level epidemiological data</strong> and are not personalized financial or medical calculations.</li>

export default function TermsOfService() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <p className="mb-8">By downloading, accessing, or using the Flair Health mobile application (&quot;App&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree, please do not use the App.</p>
      <div className="space-y-8">
        ...
        <section>
          ...
          <p>Flair Health is designed for lifestyle guidance and general wellness purposes only. The App, including its AI-generated insights, recommendations, macro estimates, and wellness protocols, is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition, diet, or fitness regimen. Never disregard professional medical advice or delay in seeking it because of something you have read in this App.</p>
        </section>
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>No Recovery:</strong> Because we do not store your data or your keys on our servers, we cannot recover your data or restore your journal if you lose your device or your 12-word phrase. Flair Health is not liable for any lost data.</li>
          </ul>
        </section>
        <section>
        ...
        <section>
          ...
          <p>These Terms are governed by the laws of [YOUR JURISDICTION]. Any disputes arising under these Terms shall be subject to the exclusive jurisdiction of the courts of [YOUR JURISDICTION].</p>
        </section>
        <section>

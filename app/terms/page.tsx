    ...
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mb-2">By using features like &quot;Level Up,&quot; &quot;Magic Lens,&quot; &quot;Eat Now,&quot; &quot;Document Scanner,&quot; &quot;Body Age,&quot; &quot;Inspire Me,&quot; and Daily Quests, you acknowledge that:</p>
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>AI inference may be performed by multiple third-party providers (currently Google Gemini, xAI Grok, and OpenAI GPT-4o-mini). Provider selection is generally automatic and based on service availability. Certain features, such as Eat Now, exclusively use Google Gemini because they require real-time location search — a capability only available through this provider.</li>
          </ul>
        </section>
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1 mb-3">
            ...
            <li><strong>xAI Grok</strong></li>
            <li><strong>OpenAI GPT-4o-mini</strong></li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-1 mb-3">
            ...
            <li><a href="https://x.ai/legal/api-terms-of-service" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">xAI Terms of Service</a></li>
          </ul>

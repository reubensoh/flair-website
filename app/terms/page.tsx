      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>AI inference may be performed by multiple third-party providers (currently Google Gemini, OpenAI GPT-4o-mini, and Anthropic Claude). Provider selection is generally automatic and based on service availability. Certain features, such as Eat Now, exclusively use Google Gemini because they require real-time location search — a capability only available through this provider.</li>
          </ul>
        </section>
        <section>

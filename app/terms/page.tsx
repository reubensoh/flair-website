    ...
    <main className="max-w-3xl mx-auto px-6 py-16 text-gray-800 dark:text-gray-200 leading-relaxed">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="mb-2">By using features like &quot;Level Up,&quot; &quot;Magic Lens,&quot; &quot;Eat Now,&quot; &quot;Document Scanner,&quot; &quot;Bio Age,&quot; and the Blueprint Protocol, you acknowledge that:</p>
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Bio Age estimations are derived from general wellness patterns and anonymised health data. They are not a clinical measurement, not validated against medical diagnostic standards, and must not be used as a substitute for professional medical assessment.</li>
            <li>AI inference may be performed by multiple third-party providers (currently Google Gemini, xAI Grok, and OpenAI GPT-4o-mini). Provider selection is automatic and based on service availability.</li>
          </ul>
        </section>
        <section>
